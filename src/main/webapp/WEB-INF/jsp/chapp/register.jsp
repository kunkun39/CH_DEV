    ...
    <div class="panel panel-default">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <spring-form:input type="text" path="username" class="form-control" required="required" placeholder="请输入邮箱"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <spring-form:input type="text" path="name" class="form-control" required="required" id="inputName" placeholder="请输入联系人姓名"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <spring-form:input id="inputPassword" type="password" path="password" class="form-control" required="required" placeholder="请输入密码" onKeyUp="pwStrength(this.value)"
                                       onBlur="pwStrength(this.value)"/>
                    <table width="150px" border="0" cellspacing="0" cellpadding="0" bordercolor="#cccccc" height="23" style='display:inline; padding-top: 5px;'>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <spring-form:input id="inputPassword" type="password" path="passwordAgain" class="form-control"  required="required" placeholder="请输入密码"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <spring-form:input type="text" path="registerCode" class="form-control" cssStyle="width: 100px;" required="required" maxlength="4"/>
            ...
            <div class="form-group">
                ...
                <label class="col-sm-10">
                    ...
                    我已阅读并接受 <a target="_blank" href="${pageContext.request.contextPath}/chapp/agreecondition.html" class="color4"><label>《广电用户协议》</label></a>
                </label>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">&nbsp;</label>
